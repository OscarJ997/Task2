            ...
            <table class="w-full border-collapse bg-white text-left text-gray-500">
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <tr scope="col" class="px-6 py-4 font-medium text-gray-900 max-h-52">
                        ...
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product_aux->product_name }}</div>
                            </div>
                        </td>
                    </tr>
                    <tr scope="col" class="px-6 py-4 font-medium text-gray-900">
                        ...
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product_aux->product_description }}</div>
                            </div>
                        </td>
                    </tr>
                    <tr scope="col" class="px-6 py-4 font-medium text-gray-900">
                        ...
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product->vendor->name }}</div>
                            </div>
                        </td>
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product_aux->vendor->name }}</div>
                            </div>
                        </td>
                    </tr>
                    <tr scope="col" class="px-6 py-4 font-medium text-gray-900">
                        ...
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product->shop->shop_name}}</div>
                            </div>
                        </td>
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product_aux->shop->shop_name }}</div>
                            </div>
                        </td>
                    </tr>
                    <tr scope="col" class="px-6 py-4 font-medium text-gray-900">
                        ...
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product->productGroup->name }}</div>
                            </div>
                        </td>
                        <td>
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $product_aux->productGroup->name }}</div>
                            </div>
                        </td>
                    </tr>
